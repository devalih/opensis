...
//	}
	...
	if(count($RET))
	{
		...
		foreach($RET as $student_id=>$course_periods)
		{
			...
			echo "<tr><td width=105>"."</td><td  style=\"font-size:15px; font-weight:bold; padding-top:20px;\">"."<div style=\"font-size:16px;\" align=Center>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Report Card (2013-2014)</div></td><td align=right style=\"padding-top:20px\">". ProperDate(DBDate()) ."<br \>United School Alyahar</td></tr><br><tr><td colspan=3 style=\"border-top:1px solid #333;\">&nbsp;&nbsp;</td></tr></table>";
...
//				}
                ...
                if($_REQUEST['elements']['signature']=='Y')
                {
                   ...
                   // echo '<tr><td align="left" width=190><span style="font-size:13px; font-weight:bold; height:30px;">Teacher&rsquo;s Signature</span><br/><br/><br/><br/></td><td width="5" valign=top>:</td><td align=left  valign=top>______________________________________</td><td valign=top align=left><span style="font-size:13px; font-weight:bold; height:30px;">Date : ______________</span></td></tr>';
                    echo '<tr><td align=left><span style="font-size:15px; font-weight:bold; height:30px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;School <br> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Administration</span><br/><br/><br/><br/></td><br><td  valign=top>:</td><td align="left"  valign=top></td>';
                    //echo '<td valign=top align=left><span style="font-size:13px; font-weight:bold; height:30px;">Date : ______________</span></td></tr>';
                    echo '<tr><td align="left"><span style="font-size:13px; font-weight:bold; height:30px;"><img src="http://s28.postimg.org/b7i99g6vt/sign.jpg" /></span></td><td  valign=top>:</td><td valign=top></td><td valign=top align=left><span style="font-size:13px; font-weight:bold; height:30px;"></span></td></tr>';
                    echo '</table>';
