...
//	}
	...
	if(count($RET))
	{
		...
		foreach($RET as $student_id=>$course_periods)
		{
			...
			echo "<tr><td width=105>"."</td><td  style=\"font-size:15px; font-weight:bold; padding-top:20px;\">". GetSchool(UserSchool()).' ('.$cur_session.')'."<div style=\"font-size:12px;\">Report Card</div></td><td align=right style=\"padding-top:20px\">". ProperDate(DBDate()) ."<br \>United School Alyahar</td></tr><tr><td colspan=3 style=\"border-top:1px solid #333;\">&nbsp;</td></tr></table>";
